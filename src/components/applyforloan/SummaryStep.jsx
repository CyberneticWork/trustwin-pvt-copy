    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-5">
          ...
          {(!data.guarantors || data.guarantors.length === 0 || !data.guarantors[0].name) && (
          ...
          <CardContent className="p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="font-medium text-blue-600">LKR {formatCurrency(parseFloat(data.vehicle.valuationAmount) * 0.7)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
