...
export async function GET() {
  try {
    ...
    try {
      ...
      const waitingLoans = Number(autoStats[0].waiting) + Number(businessStats[0].waiting);
      const approvedLoans = Number(autoStats[0].approved) + Number(businessStats[0].approved);
