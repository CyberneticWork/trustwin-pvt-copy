...
export default function EquipmentLoanCalculatorPage() {
    ...
    console.log(list);
      ...
      const loanData = {
        ...
        initial_charges: {
          ...
          total_charges: serviceCharges + documentCharges + insurancePremium + introducerCommission + otherCharges,
  ...
  useEffect(() => {
    ...
    const totalInitialCharges = showInitialCharges ? 
      serviceCharges + documentCharges + insurancePremium + introducerCommission + otherCharges : 0;
  ...
  const getInitialChargesDisplay = () => {
    ...
    const totalCharges = serviceCharges + documentCharges + insurancePremium + introducerCommission + otherCharges;
    let prefix = '';
    let textColor = '';
  ...
  return (
    <div style={{ width: "100%", maxWidth: "1200px", margin: "0 auto", padding: "20px", overflowX: "hidden" }}>
      <h1 style={{ fontSize: "24px", fontWeight: "semi-bold", marginBottom: "20px" }}>Equipment Loan Calculator</h1>
        ...
        <div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter information about the equipment and desired loan terms</CardDescription>
            </CardHeader>
            <CardContent>
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                {/* Equipment Price */}
                <div style={{ marginBottom: "8px" }}>
                  <Label htmlFor="equipmentPrice" style={{ display: "block", marginBottom: "4px" }}>Equipment Price</Label>
                  <Input
                    id="equipmentPrice"
                    type="number"
                ...
                <div style={{ marginBottom: "8px" }}>
                  ...
                  <p style={{ fontSize: "12px", color: "#666", marginTop: "4px" }}>
                    {((downPayment / equipmentPrice) * 100).toFixed(1)}% of equipment price
                  </p>
                </div>
                    ...
                    <div style={{ backgroundColor: "#f8f8f8", padding: "16px", borderRadius: "4px", border: "1px solid #ddd", marginTop: "16px" }}>
                      ...
                      <div style={{ marginTop: "16px", display: "flex", flexDirection: "column", gap: "8px" }}>
                        <p style={{ fontSize: "14px", fontWeight: "500" }}>
                          Total Initial Charges: {formatCurrency(serviceCharges + documentCharges + insurancePremium + introducerCommission + otherCharges)}
                        </p>
            ...
            <CardContent>
              {results ? (
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                    <div>
                      <p style={{ fontSize: "14px", color: "#666" }}>Equipment Price</p>
                  ...
                  <div style={{ marginTop: "8px" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", fontSize: "14px" }}>
                      ...
                      <div>
                        ...
                        <span style={{ marginLeft: "4px" }}>{formatCurrency(equipmentPrice)}</span>
                      </div>
                      <div>
      ...
      <div style={{ 
        ...
        <p style={{ fontSize: "16px", maxWidth: "600px", margin: "0 auto 20px auto" }}>
          Apply now to secure your equipment loan with our competitive rates and flexible terms.
        </p>
        <Button style={{ 
          backgroundColor: "#2563eb", 
          fontSize: "16px", 
