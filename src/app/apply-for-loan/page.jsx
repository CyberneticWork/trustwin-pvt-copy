  ...
  const validateStep = (step) => {
    if (step === 0) {
      ...
      const isGuarantorComplete = Boolean(
        ...
        loanApplicationData.guarantorIdNo && 
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="border-2 border-dashed rounded-lg p-6 text-center cursor-pointer hover:bg-slate-50 flex flex-col items-center justify-center">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="guarantorIdNo" className="text-sm font-medium">
                Guarantor ID No <span className="text-red-500">*</span>
              </Label>
              <Input 
                id="guarantorIdNo" 
                value={loanApplicationData.guarantorIdNo}
                onChange={(e) => handleChange('guarantorIdNo', e.target.value)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => handleChange('guarantorRelationship', value)}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                onChange={(e) => handleChange('guarantorMobile', e.target.value)}
          ...
          <div className="space-y-2">
            <Label htmlFor="guarantorAddress1" className="text-sm font-medium">
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                value={loanApplicationData.guarantorAddress2}
                onChange={(e) => handleChange('guarantorAddress2', e.target.value)}
                placeholder="Area, Village" 
              />
              <Input 
                id="guarantorAddress3" 
                value={loanApplicationData.guarantorAddress3}
                onChange={(e) => handleChange('guarantorAddress3', e.target.value)}
                placeholder="City" 
              />
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium">{loanApplicationData.guarantorIdNo}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium">{loanApplicationData.guarantorRelationship}</p>
              </div>
              <div>
            ...
            <div>
              ...
              <p className="font-medium">
                {loanApplicationData.guarantorAddress1}
                {loanApplicationData.guarantorAddress2 ? `, ${loanApplicationData.guarantorAddress2}` : ''}
                {loanApplicationData.guarantorAddress3 ? `, ${loanApplicationData.guarantorAddress3}` : ''}
              </p>
            </div>
          </div>
